...
graph TD
    ...
    subgraph "Modern (v3)"
        ...
        M_R2 -->|CDN Delivery| M_CDN[cdn.avxt.qzz.io]
    end
...
- **[CORS_FIXED]** Hardened **Cloudflare CORS Policy** for `avrxt.dev`, `www.avrxt.dev`, and local development.
...
*   **Strategic Fix**: Cloudflare R2 assets are delivered through the shared `cdn.avxt.qzz.io` custom domain.
